...
public class Employee {
    ...
    public boolean equals(Object o) {
        ...
        return id == employee.id &&
                ...
                Objects.equals(speciality, employee.speciality);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        return "Exercise1.Employee{" +

           "id=" + id + ", name='" + name + '\'' + ", lastName='" + lastName + '\'' + ", gender=" + gender + ", age=" + age + ", salary=" + salary + ", workExperience=" + workExperience + ", speciality=" + speciality + '}';
    }
}
